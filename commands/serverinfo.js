...
module.exports = {
  ...
  run: function (client, message, args) {
    ...
    const embed = new Discord.RichEmbed()
      ...
      .addField('**Humanos | Bots Online**', `${message.guild.members.filter(member => !member.user.bot).size} | ${message.guild.members.filter(member => member.user.bot).size}`)
